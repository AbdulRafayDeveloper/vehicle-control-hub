...
const MReactTable = ({
  ...
  initialState,
  manualPagination = false, // Boolean to enable frontend pagination
  ...
  return (
    <Paper sx={{ p: '20px 16px', borderRadius: '32px' }}>
      <MaterialReactTable
        columns={columns}
        data={
          activeDataKey
            ? data[activeDataKey]?.data || [] //show the data selected key in case of multiple data lists
            : typeof api === 'function'
            ? data?.data // show the data coming from api function passed as props
            : rest.data //show the data coming from props instead of calling the api
        }
        enableRowSelection={
        ...
        onPaginationChange={
          manualPagination ? onPaginationChange : setFrontendPagination
        }
        ...
        state={{
          ...
          globalFilter,
          isLoading,
          pagination: manualPagination ? pagination : frontendPagination,
        ...
        muiTableBodyRowProps={({ row }) => ({
          ...
          sx: {
            ...
            '& .MuiTableCell-root.MuiTableCell-body': {
              ...
              background:
                row.index === activeRow && collapsed ? '#bdbdbd42' : 'white',
            },
            '&:hover .show-on-hover': {
              display: 'inline',
              // display: 'visible'
        ...
        muiTableContainerProps={
          !collapsed
            ? {
                sx: {
                  height: `calc(77vh - ${takenHeight}px)`,
                  overflow: 'auto',
                },
              }
            : undefined
